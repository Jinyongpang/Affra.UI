    ...
    public partial class HIPAndLWPSummaryDataGrid
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            customColumns = (await serviceScope.ServiceProvider.GetRequiredService<IExtraColumnService>()
                .GetCustomColumns(nameof(DailyHIPAndLWPSummary))
        ...
        private async Task ShowDialogAsync(DailyHIPAndLWPSummary data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<HIPAndLWPSummaryDialog>(title,
