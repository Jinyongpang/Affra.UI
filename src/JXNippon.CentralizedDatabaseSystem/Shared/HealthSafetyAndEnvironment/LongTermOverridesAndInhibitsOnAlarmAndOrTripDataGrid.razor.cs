...
namespace JXNippon.CentralizedDatabaseSystem.Shared.HealthSafetyAndEnvironment
{
    ...
    {
        private RadzenDataGrid<DailyLongTermOverridesInhibitsOnAlarmTrip> grid;
        private IEnumerable<DailyLongTermOverridesInhibitsOnAlarmTrip> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyLongTermOverridesInhibitsOnAlarmTrip>();
        ...
        private IGenericService<DailyLongTermOverridesInhibitsOnAlarmTrip> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyLongTermOverridesInhibitsOnAlarmTrip, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyLongTermOverridesInhibitsOnAlarmTrip data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<LongTermOverridesInhibitsOnAlarmTripDialog>(title,
