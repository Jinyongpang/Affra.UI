...
{
    public partial class HealthSafetyAndEnvironmentDataGrid
    {
        private RadzenDataGrid<DailyHealthSafetyEnvironment> grid;
        private IEnumerable<DailyHealthSafetyEnvironment> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyHealthSafetyEnvironment>();
        ...
        private IGenericService<DailyHealthSafetyEnvironment> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyHealthSafetyEnvironment, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyHealthSafetyEnvironment data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<HealthSafetyEnvironmentDialog>(title,
