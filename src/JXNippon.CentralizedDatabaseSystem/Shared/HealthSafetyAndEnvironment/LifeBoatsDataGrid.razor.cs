...
namespace JXNippon.CentralizedDatabaseSystem.Shared.HealthSafetyAndEnvironment
{
    ...
    {
        private RadzenDataGrid<DailyLifeBoat> grid;
        private IEnumerable<DailyLifeBoat> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyLifeBoat>();
        ...
        private IGenericService<DailyLifeBoat> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyLifeBoat, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyLifeBoat data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<LifeBoatDialog>(title,
