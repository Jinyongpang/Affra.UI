...
namespace JXNippon.CentralizedDatabaseSystem.Shared.HealthSafetyAndEnvironment
{
    ...
    {
        private RadzenDataGrid<DailyLossOfPrimaryContainmentIncident> grid;
        private IEnumerable<DailyLossOfPrimaryContainmentIncident> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyLossOfPrimaryContainmentIncident>();
        ...
        private IGenericService<DailyLossOfPrimaryContainmentIncident> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyLossOfPrimaryContainmentIncident, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyLossOfPrimaryContainmentIncident data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<LossOfPrimaryContainmentIncidentDialog>(title,
