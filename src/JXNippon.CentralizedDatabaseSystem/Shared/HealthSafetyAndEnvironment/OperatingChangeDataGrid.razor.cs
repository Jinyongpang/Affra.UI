...
namespace JXNippon.CentralizedDatabaseSystem.Shared.HealthSafetyAndEnvironment
{
    ...
    {
        private RadzenDataGrid<DailyOperatingChange> grid;
        private IEnumerable<DailyOperatingChange> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyOperatingChange>();
        ...
        private IGenericService<DailyOperatingChange> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyOperatingChange, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyOperatingChange data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<OperatingChangeDialog>(title,
