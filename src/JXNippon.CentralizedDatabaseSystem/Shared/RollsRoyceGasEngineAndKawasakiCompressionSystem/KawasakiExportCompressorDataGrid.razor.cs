...
namespace JXNippon.CentralizedDatabaseSystem.Shared.RollsRoyceGasEngineAndKawasakiCompressionSystem
{
    ...
    {
        private RadzenDataGrid<DailyKawasakiExportCompressor> grid;
        private IEnumerable<DailyKawasakiExportCompressor> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyKawasakiExportCompressor>();
        ...
        private IGenericService<DailyKawasakiExportCompressor> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyKawasakiExportCompressor, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyKawasakiExportCompressor data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<KawasakiExportCompressorDialog>(title,
