...
{
    public partial class MaximoWorkOrderFilterPanel
    {
        private IEnumerable<DailyMaximoWorkOrder> datas;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            datas = (await serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyMaximoWorkOrder, ICentralizedDatabaseSystemUnitOfWork>>()
                .Get()
                .ToQueryOperationResponseAsync<DailyMaximoWorkOrder>()).ToList();
        }
