...
namespace JXNippon.CentralizedDatabaseSystem.Shared.MajorEquipment
{
    public partial class MajorEquipmentStatusDataGrid
    {
        ...
        private async Task ShowDialogAsync(DailyMajorEquipmentStatus data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<MajorEquipmentStatusDialog>(title,
