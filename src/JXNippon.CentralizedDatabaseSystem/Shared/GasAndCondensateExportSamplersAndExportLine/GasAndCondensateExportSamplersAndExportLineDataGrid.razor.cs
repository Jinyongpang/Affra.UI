...
namespace JXNippon.CentralizedDatabaseSystem.Shared.GasAndCondensateExportSamplersAndExportLine
{
    public partial class GasAndCondensateExportSamplersAndExportLineDataGrid
    {
        ...
        private async Task ShowDialogAsync(DailyGasCondensateExportSamplerAndExportLine data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<GasCondensateExportSamplerAndExportLineDialog>(title,
