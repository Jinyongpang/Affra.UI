...
{
    public partial class IntegerDescriptionItemEdit<TItem>
        where TItem : class
    {
        [Parameter] public int? Integer { get; set; }
        ...
        [Parameter] public EventCallback<int?> IntegerChanged { get; set; }
        [Parameter] public EventCallback<int?> OnIntegerChanged { get; set; }
        ...
        private async Task StopEdit()
        {
            try
            {
                await IntegerChanged.InvokeAsync(this.Integer);
                await OnIntegerChanged.InvokeAsync(this.Integer);
