...
{
    public partial class InowacInjectionDataGrid
    {
        private RadzenDataGrid<DailyInowacInjection> grid;
        private IEnumerable<DailyInowacInjection> items;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            customColumns = (await serviceScope.ServiceProvider.GetRequiredService<IExtraColumnService>()
                .GetCustomColumns(nameof(DailyInowacInjection))
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyInowacInjection>();
        ...
        private IGenericService<DailyInowacInjection> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyInowacInjection, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyInowacInjection data, int menuAction, string title)
        {
