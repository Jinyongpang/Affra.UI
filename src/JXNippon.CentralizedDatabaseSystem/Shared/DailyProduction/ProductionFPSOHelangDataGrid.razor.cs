...
namespace JXNippon.CentralizedDatabaseSystem.Shared.DailyProduction
{
    public partial class ProductionFPSOHelangDataGrid
    {
        ...
        private async Task ShowDialogAsync(DailyFPSOHelangProduction data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<FPSOHelangProductionDialog>(title,
