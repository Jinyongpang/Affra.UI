...
namespace JXNippon.CentralizedDatabaseSystem.Shared.DailyProduction
{
    public partial class ProductionSK10DataGrid
    {
        ...
        private async Task ShowDialogAsync(DailySK10Production data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<ProductionSK10Dialog>(title,
