...
namespace JXNippon.CentralizedDatabaseSystem.Shared.WellHead
{
    public partial class HIPWellHeadParameterDataGrid
    {
        ...
        private async Task ShowDialogAsync(DailyHIPWellHeadParameter data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<HIPWellHeadParameterDialog>(title,
