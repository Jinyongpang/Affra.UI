...
namespace JXNippon.CentralizedDatabaseSystem.Shared.WellHead
{
    public partial class LWPWellHeadParameterDataGrid
    {
        ...
        private async Task ShowDialogAsync(DailyLWPWellHeadParameter data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<LWPWellHeadParameterDialog>(title,
