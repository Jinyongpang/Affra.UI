...
namespace JXNippon.CentralizedDatabaseSystem.Shared.GlycolRegenerationSystem
{
    ...
    {
        private RadzenDataGrid<DailyGlycolPump> grid;
        private IEnumerable<DailyGlycolPump> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyGlycolPump>();
        ...
        private IGenericService<DailyGlycolPump> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyGlycolPump, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyGlycolPump data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<GlycolPumpDialog>(title,
