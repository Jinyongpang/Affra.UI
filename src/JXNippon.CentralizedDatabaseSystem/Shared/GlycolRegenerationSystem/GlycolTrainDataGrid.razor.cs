...
namespace JXNippon.CentralizedDatabaseSystem.Shared.GlycolRegenerationSystem
{
    ...
    {
        [Parameter] public Collection<DailyGlycolTrain> Data { get; set; }
        [Parameter] public EventCallback<Collection<DailyGlycolTrain>> DataChanged { get; set; }
        ...
        public DailyDataGrid<DailyGlycolTrain, GlycolTrainDialog> DailyDataGrid { get; set; }
