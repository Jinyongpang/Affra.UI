...
{
    public partial class GlycolTrainDataGrid
    {
        private RadzenDataGrid<DailyGlycolTrain> grid;
        private IEnumerable<DailyGlycolTrain> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyGlycolTrain>();
        ...
        private IGenericService<DailyGlycolTrain> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyGlycolTrain, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyGlycolTrain data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<GlycolTrainDialog>(title,
