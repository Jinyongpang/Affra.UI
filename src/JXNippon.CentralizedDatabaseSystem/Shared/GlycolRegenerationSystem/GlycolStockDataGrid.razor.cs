...
namespace JXNippon.CentralizedDatabaseSystem.Shared.GlycolRegenerationSystem
{
    ...
    {
        private RadzenDataGrid<DailyGlycolStock> grid;
        private IEnumerable<DailyGlycolStock> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyGlycolStock>();
        ...
        private IGenericService<DailyGlycolStock> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyGlycolStock, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyGlycolStock data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<GlycolStockDialog>(title,
