...
namespace JXNippon.CentralizedDatabaseSystem.Shared.CoolingMediumSystem
{
    ...
    {
        private RadzenDataGrid<DailyAnalysisResult> grid;
        private IEnumerable<DailyAnalysisResult> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyAnalysisResult>();
        ...
        private IGenericService<DailyAnalysisResult> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyAnalysisResult, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyAnalysisResult data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<AnalysisResultDialog>(title,
