...
namespace JXNippon.CentralizedDatabaseSystem.Shared.CoolingMediumSystem
{
    ...
    {
        private RadzenDataGrid<DailyCoolingMediumSystem> grid;
        private IEnumerable<DailyCoolingMediumSystem> items;
        ...
        private async Task LoadDataAsync(LoadDataArgs args)
        {
            ...
            if (CommonFilter != null)
            {
                ...
                {
                    query = query.Where(x => x.CoolingMediumSystemName.ToUpper().Contains(CommonFilter.Search.ToUpper()));
                }
            ...
            var response = await query
                ...
                .ToQueryOperationResponseAsync<DailyCoolingMediumSystem>();
        ...
        private IGenericService<DailyCoolingMediumSystem> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<DailyCoolingMediumSystem, ICentralizedDatabaseSystemUnitOfWork>>();
        }

        private async Task ShowDialogAsync(DailyCoolingMediumSystem data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<CoolingMediumSystemDialog>(title,
