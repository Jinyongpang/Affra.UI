...
{
    public partial class LayangGasTemplateReportView
    {
        private bool isCollapsed = false;
        private Menu menu;
        private LayangGasTemplateReport Items { get; set; }
        ...
        private IGenericService<LayangGasTemplateReport> GetGenericService(IServiceScope serviceScope)
        {
            return serviceScope.ServiceProvider.GetRequiredService<IUnitGenericService<LayangGasTemplateReport, ICentralizedDatabaseSystemUnitOfWork>>();
        }
        public async Task LoadDataAsync(int? selectedYear = null)
        {
            ...
            if (selectedYear is null)
            {
                Items = (await service.Get()
                    ...
                    .ToQueryOperationResponseAsync<LayangGasTemplateReport>())
                    .FirstOrDefault();
            }
            else
            {
