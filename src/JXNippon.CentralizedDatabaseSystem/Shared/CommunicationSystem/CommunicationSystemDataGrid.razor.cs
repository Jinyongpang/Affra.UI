...
namespace JXNippon.CentralizedDatabaseSystem.Shared.CommunicationSystem
{
    public partial class CommunicationSystemDataGrid
    {
        ...
        private async Task ShowDialogAsync(DailyCommunicationSystem data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<CommunicationSystemDialog>(title,
