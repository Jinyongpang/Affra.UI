...
namespace JXNippon.CentralizedDatabaseSystem.Shared.WellHeadAndSeparationSystem
{
    public partial class WellHeadAndSeparationSystemDataGrid
    {
        ...
        private async Task ShowDialogAsync(DailyWellHeadAndSeparationSystem data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<WellHeadAndSeparationSystemDialog>(title,
