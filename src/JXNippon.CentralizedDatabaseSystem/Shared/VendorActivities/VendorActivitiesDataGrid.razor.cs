...
namespace JXNippon.CentralizedDatabaseSystem.Shared.VendorActivities
{
    public partial class VendorActivitiesDataGrid
    {
        ...
        private async Task ShowDialogAsync(DailyVendorActivity data, int menuAction, string title)
        {
            ...
            {
                response = await DialogService.OpenAsync<VendorActivityDialog>(title,
